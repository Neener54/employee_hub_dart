import 'package:employee_hub/employee_hub.dart';
import 'package:aqueduct/test.dart';

export 'package:employee_hub/employee_hub.dart';
export 'package:aqueduct/test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for employee_hub.
///
/// Use instances of this class to start/stop the test employee_hub server. Use [client] to execute
...
class TestApplication {
  ...
  TestApplication() {
    configuration = new EmployeeHubConfiguration("config.yaml.src");
    configuration.database.isTemporary = true;
  }

  Application<EmployeeHubSink> application;
  EmployeeHubSink get sink => application.mainIsolateSink;
  TestClient client;
  EmployeeHubConfiguration configuration;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [EmployeeHubSink].
  /// The declared [ManagedObject]s in this application will be
  /// used to generate a temporary database schema. The [EmployeeHubSink] instance will use
  ...
  Future start() async {
    ...
    application = new Application<EmployeeHubSink>();
