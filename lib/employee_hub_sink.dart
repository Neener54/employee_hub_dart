...
///
/// See the documentation in this file for [initializeApplication], [EmployeeHubSink], [setupRouter] and [willOpen]
...
/// for more details.
class EmployeeHubSink extends RequestSink {
  ...
  static Future initializeApplication(ApplicationConfiguration config) async {
    ...
    var configFileValues =
        new EmployeeHubConfiguration(config.configurationFilePath);
  ...
  EmployeeHubSink(ApplicationConfiguration options) : super(options) {
  ...
  void setupRouter(Router router) {
    router.route("/").generate(() => new AuthCodeController(authServer,
...
class EmployeeHubConfiguration extends ConfigurationItem {
  EmployeeHubConfiguration(String fileName) : super.fromFile(fileName);
